...
def execute_gp_model():
    ...
    force_response_kernel_type = ['squared_exponential', 'p_se_composite', 'white_noise', 'wn_se_composite', 'periodic', 'cosine', 'cosine_composite'][1]
    ...
    force_response_U_induced_method = ['k_means', 'even'][0]
