...
def execute_gp_model():
    ...
    force_input_solver_type = ['metropolis_hastings', 'iterative_search', 'adam', 'free_lunch'][2]
    force_input_predict_type = ['cholesky', 'FITC'][0]
    force_input_nll_method = ['cholesky', 'FITC_18_134'][1]
    force_input_U_induced_method = ['k_means', 'even'][0]
    ...
    force_response_solver_type = ['metropolis_hastings', 'iterative_search', 'adam', 'free_lunch'][2]
